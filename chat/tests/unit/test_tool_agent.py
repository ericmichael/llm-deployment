...
from chat.ai.tool_agent import ToolAgent, ToolInvoker
from unittest.mock import MagicMock


class TestToolAgent(TestCase):
    def setUp(self):
        self.tools = {
            "search_food": {
                "params": "query",
        ...
        self.agent = ToolAgent(tools=self.tools)

    @vcr.use_cassette(
        "chat/tests/fixtures/vcr_cassettes/tool_agent.yaml",
