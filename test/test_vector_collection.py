# import unittest
# import vcr
# from app.utils.vector_collection import Document, VectorCollection  # replace 'your_module' with the name of your module
...
#     @vcr.use_cassette('test/fixtures/vcr_cassettes/vector_collection.yaml', filter_headers=[('authorization', None)])
